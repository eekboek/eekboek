# generated by wxGlade 0.4cvs*** on Tue Sep  6 11:54:03 2005
...
# end wxGlade
	...
	$self->SetSize([$config->lsdw->{xwidth}, $config->lsdw->{ywidth}]) if $config;
...
sub closehandler {
    my ($self, $retval) = @_;
    @{$config->get("lsdw")}{qw(xpos ypos xwidth ywidth)} =
      ($self->GetPositionXY, $self->GetSizeWH) if $config;
